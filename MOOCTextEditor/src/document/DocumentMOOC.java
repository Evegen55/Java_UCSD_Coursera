...
public abstract class DocumentMOOC {
	 ...
	 */
	protected DocumentMOOC(String text)
	{
		this.text = text;
	}
	 ...
	 *
	 * @param basicDocumentMOOC The Document object to test
	...
	public static boolean testCaseMOOC(DocumentMOOC basicDocumentMOOC, int syllables, int words, int sentences)
	{
		...
		boolean passed = true;
		int syllFound = basicDocumentMOOC.getNumSyllables();
		int wordsFound = basicDocumentMOOC.getNumWords();
		int sentFound = basicDocumentMOOC.getNumSentences();
